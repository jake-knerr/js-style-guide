...
Welcome to my JavaScript Style Guide. This guide aims to be a comprehensive description of Blotli's standards for JavaScript source code.
...
Blotli uses Wikipedia's style guide for English located here: [Wikipedia:Manual of Style [English]](https://en.wikipedia.org/wiki/Wikipedia:Manual_of_Style).
