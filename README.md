...
- **Export class if there are (possibly) multiple instances required, you need a consistent technique across a series of related components, or extension may be necessary.**
